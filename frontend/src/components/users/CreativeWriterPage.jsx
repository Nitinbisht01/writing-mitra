...
Return ONLY pure HTML content. Nothing else.
        ...
        {
          headers: {
            Authorization: "Bearer sTK2F714yqTDCuwCQegoOvCYuTnhgk0wTkxUnY7c",
 ...
 //  Download Clean PDF 
  const downloadPDF = () => {
    ...
    pdfContainer.style.lineHeight = "1.4"; // FIXED GAP
    ...
    <div className="page-container d-flex justify-content-center align-items-center">
      ...
      <div className="card-custom">
        ...
        >Submit </button>
          ...
          <img src="/loading.jpg" alt="" style={{width:"100px"}} />
          </div>
          </>}
        ...
        {data.result && ( <>
          ...
          <button className="btn btn-success w-100 mt-3 "onClick={downloadPDF}>Download Pdf</button>
          </>
        )}
      </div>
    </div>
